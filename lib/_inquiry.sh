...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu Litezap Chat que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Litezap Chat, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Litezap Chat\n"
  printf "   [1] Atualizar Litezap ChatP\n"
  printf "   [2] Deletar Litezap Chat\n"
  printf "   [3] Bloquear Litezap ChatP\n"
  printf "   [4] Desbloquear Litezap Chat\n"
  printf "   [5] Alter. dominio Litezap Chat\n"
  printf "\n"
  read -p "> " option
